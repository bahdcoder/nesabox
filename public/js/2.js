...
var render = function() {
  ...
  return _c("layout", [
    _c(
      ...
      [
        _c("h3", { staticClass: "text-xl font-semibold" }, [_vm._v("Servers")]),
        _vm._v(" "),
        _c(
          "router-link",
          {
            staticClass:
              "inline-flex items-center px-4 py-2 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-sha-green-500 hover:bg-sha-green-400 focus:outline-none focus:border-sha-green-600 focus:shadow-outline-sha-green active:bg-sha-green-600 transition ease-in-out duration-150",
            attrs: { to: "/servers/create" }
          },
          [_vm._v("\n            Add new server\n        ")]
        )
      ],
