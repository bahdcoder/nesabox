...
/* harmony import */ var _Pages_Servers_Databases_Mongodb__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/Pages/Servers/Databases/Mongodb */ "./resources/js/Pages/Servers/Databases/Mongodb.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Mongodb: _Pages_Servers_Databases_Mongodb__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  data: function data() {
    return {};
  },
  ...
  return _c(
    ...
    [
      _c(
        "template",
        { slot: "content" },
        [_c(_vm.$route.params.database, { tag: "component" })],
        1
      )
    ],
    2
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        [
          _c("v-table", {
            attrs: { headers: _vm.databasesTable.headers, rows: _vm.databases },
            scopedSlots: _vm._u([
              {
                key: "row",
                fn: function(ref) {
