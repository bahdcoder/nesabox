                ...
                [
                  ...
                  _c("text-input", {
                    ...
                    attrs: {
                      ...
                      help:
                        "Provide which ports you want this server to have access to. You can add multiple ports separated by commas. For example, if you want this server to be able to access a Mongodb server and Redis server, provide ports 27017,6379"
                    },
                    model: {
