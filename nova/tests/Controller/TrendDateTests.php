...
trait TrendDateTests
{
    ...
    public function test_trend_count_can_be_retrieved_by_month($date)
    {
        ...
        $response = $this->withExceptionHandling()->get(
            '/nova-api/posts/metrics/post-count-trend?range=6'
        );
        ...
        $this->assertEquals(
            1,
            $response->original['value']->trend[Chronos::now()->format('F Y')]
        );
    ...
    public function test_trend_count_can_be_retrieved_by_month_by_user($date)
    {
        ...
        $response = $this->withExceptionHandling()->get(
            '/nova-api/posts/1/metrics/post-count-trend?range=6'
        );
     ...
     * @dataProvider trendDateProvider
     */
    public function test_trend_count_can_be_retrieved_by_month_with_timezone(
        $date
    ) {
        Chronos::setTestNow($date);
        ...
        $response = $this->withExceptionHandling()->get(
            '/nova-api/posts/metrics/post-count-trend?range=6&timezone=America/Chicago'
        );
    ...
    public function test_trend_count_can_be_retrieved_by_week($date)
    {
        ...
        $this->assertEquals(
            1,
            $response->original['value']->trend[
                $startingDate->format('F j') .
                    ' - ' .
                    $endingDate->format('F j')
            ]
        );
     ...
     * @dataProvider trendDateProvider
     */
    public function test_trend_count_can_be_retrieved_by_week_with_timezone(
        $date
    ) {
        Chronos::setTestNow($date);
     ...
     * @dataProvider trendDateProvider
     */
    public function test_trend_count_can_be_retrieved_by_hours_with_timezone(
        $date
    ) {
        Chronos::setTestNow($date);
     ...
     * @dataProvider trendDateProvider
     */
    public function test_trend_count_can_be_retrieved_by_minute_with_timezone(
        $date
    ) {
        Chronos::setTestNow($date);
     ...
     * @dataProvider trendDateProvider
     */
    public function test_trend_count_can_be_retrieved_by_minute_in_12_hour_time(
        $date
    ) {
        Chronos::setTestNow($date);
        ...
        $response = $this->withExceptionHandling()->get(
            '/nova-api/posts/metrics/post-count-trend?range=6&twelveHourTime=true'
        );
     ...
     * @dataProvider trendDateProvider
     */
    public function test_trend_count_can_be_retrieved_by_minute_in_12_hour_time_and_timezone(
        $date
    ) {
        Chronos::setTestNow($date);
        ...
        $response = $this->withExceptionHandling()->get(
            '/nova-api/posts/metrics/post-count-trend?range=6&twelveHourTime=true&timezone=America/Chicago'
        );
    ...
    public function test_trend_average_can_be_retrieved_by_month($date)
    {
        ...
        $response = $this->withExceptionHandling()->get(
            '/nova-api/posts/metrics/post-average-trend?range=6'
        );
    ...
    public function test_trend_sum_can_be_retrieved_by_month($date)
    {
        ...
        $response = $this->withExceptionHandling()->get(
            '/nova-api/posts/metrics/post-sum-trend?range=6'
        );
    ...
    public function test_trend_max_can_be_retrieved_by_month($date)
    {
        ...
        $response = $this->withExceptionHandling()->get(
            '/nova-api/posts/metrics/post-max-trend?range=6'
        );
    ...
    public function test_trend_min_can_be_retrieved_by_month($date)
    {
        ...
        $response = $this->withExceptionHandling()->get(
            '/nova-api/posts/metrics/post-min-trend?range=6'
        );
