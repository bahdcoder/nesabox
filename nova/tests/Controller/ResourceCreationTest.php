...
class ResourceCreationTest extends IntegrationTest
{
    ...
    public function test_parent_resource_policy_may_prevent_adding_related_resources()
    {
        ...
        $this->assertInstanceOf(
            User::class,
            $_SERVER['nova.user.addPostModel']
        );
    ...
    public function test_can_create_resource_via_parent_resource()
    {
        ...
        $response = $this->withExceptionHandling()->postJson(
            '/nova-api/posts?viaResource=users&viaResourceId=1&viaRelationship=posts',
            [
                'user' => $user->id,
                'title' => 'Fake Title'
            ]
    ...
    public function test_resource_that_belongs_to_parent_via_has_one_can_be_created()
    {
        ...
        $response = $this->withExceptionHandling()->postJson(
            '/nova-api/addresses?viaResource=users&viaResourceId=1&viaRelationship=address',
            [
                'user' => $user->id,
                'name' => 'Fake Name'
            ]
    ...
    public function test_related_resource_should_be_able_to_be_updated_even_when_full()
    {
        ...
        $response = $this->withExceptionHandling()->putJson(
            '/nova-api/addresses/' .
                $address->id .
                '?viaResource=users&viaResourceId=1&viaRelationship=address',
            [
                'user' => $user->id,
                'name' => 'Fake Name'
            ]
    ...
    public function test_action_event_should_honor_custom_polymorphic_type_for_resource_creation()
    {
        ...
        $this->withExceptionHandling()->postJson('/nova-api/users', [
            'name' => 'Taylor Otwell',
            'email' => 'taylor@laravel.com',
            'password' => 'password'
        ]);
    ...
    {
        $response = $this->withoutExceptionHandling()->postJson(
            '/nova-api/users',
            [
                'name' => 'David Hemphill',
