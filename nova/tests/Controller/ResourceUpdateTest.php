...
class ResourceUpdateTest extends IntegrationTest
{
    ...
    public function test_can_update_resources()
    {
        ...
        $this->assertSubset(
            ...
            $actionEvent->original
        );
        $this->assertSubset(
            ['name' => 'David Hemphill', 'email' => 'david@laravel.com'],
            $actionEvent->changes
        );
    ...
    public function test_readonly_fields_are_not_validated()
    {
        ...
        $this->withExceptionHandling()
            ->putJson(
                sprintf(
                    '/nova-api/users/%s?editing=true&editMode=update',
                    $user->id
                ),
                [
                    'name' => 'Taylor Otwell',
    ...
    public function test_resource_can_redirect_to_custom_uri_on_update()
    {
        ...
        $response = $this->withExceptionHandling()->putJson(
            '/nova-api/users-with-redirects/' . $user->id,
            [
                'name' => 'Taylor Otwell',
                'email' => 'taylor@laravel.com',
                'password' => 'password'
    ...
    public function test_select_resource_query_count_on_update()
    {
        ...
        $queries = count(
            array_filter(DB::getQueryLog(), function ($log) {
                return $log['query'] ===
