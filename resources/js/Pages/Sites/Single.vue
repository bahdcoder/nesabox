    ...
    methods: {
        ...
        quickDeploy(disabling = false) {
            ...
            axios
                ...
                .catch(({ response }) => {
                    this.$root.flashMessage(
                        response.data.message || !disabling
                            ? 'Failed to disable push to deploy.'
                            : 'Failed to enable push to deploy. This might be because you have not granted access to this repository organisation.',
                        'error'
                    )
                })
                .finally(() => {
