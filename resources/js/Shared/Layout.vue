<template>
    <div class="flex flex-col min-h-screen">
                ...
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img
                                class="h-12 w-12"
                                src="/assets/images/logo-light-small.svg"
                                alt=""
                            />
                        </div>
                            ...
                            <div class="ml-3 relative">
                                ...
                                >
                                    <div class="rounded-md bg-white shadow-xs">
                                        ...
                                        <div class="py-1">
                                            <span
                                                class="w-full font-semibold inline-block mb-3 text-xs text-gray-900 px-4 py-3 border-b border-gray-100"
                                                >Projects</span
                                            >
                                            <a
                                                href="#"
        ...
        <main class="px-3 flex-grow mb-12 md:mb-24">
        ...
        <div class="bg-gray-800">
            <div class="max-w-screen-xl mx-auto py-8 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
                <div class="flex justify-center md:order-2">
                    <a href="https://twitter.com/bahdcoder" class="ml-6 text-gray-400 hover:text-gray-500">
                        <span class="sr-only">Twitter</span>
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"/>
                        </svg>
                    </a>
                    <a href="https://github.com/bahdcoder" class="ml-6 text-gray-400 hover:text-gray-500">
                ...
                <div class="mt-8 md:mt-0 md:order-1">
                    <p class="text-center text-base leading-6 text-gray-400">
                        &copy; {{ new Date().getFullYear() }} A Project by Kati Frantz
                    </p>
                </div>
            </div>
            </div>
