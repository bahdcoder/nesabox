...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Nesabox is a simple service for provisioning and deploying unlimited Node.js applications on DigitalOcean, Linode, Vultr, Amazon and more.">

        <meta property="og:site_name" content="Nesabox"/>
        <meta property="og:title" content="Nesabox"/>
        <meta property="og:description" content="Nesabox is a simple service for provisioning and deploying unlimited Node.js applications on DigitalOcean, Linode, Vultr, Amazon and more."/>
        ...
        <link rel="home" href="https://nesabox.com">
    ...
    <body class='antialiased'>
        ...
        <nav class="container lg:px-0 py-6 mx-auto md:pt-12 px-6 flex relative justify-between items-center z-10">
