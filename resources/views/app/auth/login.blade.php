...
@section('content')
  <div class="min-h-screen bg-gray-100 flex flex-col justify-center py-12 px-3 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <img class="mx-auto h-8 w-auto" src="{{ asset('assets/images/logo.svg') }}" alt="Workflow" />
        ...
        <form action="#" method="POST">
          ...
          <div class="mt-6 flex items-center justify-between">
            <div class="flex items-center">
              <input id="remember_me" type="checkbox" class="form-checkbox h-4 w-4 text-sha-green-500 transition duration-150 ease-in-out" />
            ...
            <div class="text-sm leading-5">
              <a href="#" class="font-medium text-sha-green-500 hover:text-sha-green-600 focus:outline-none focus:underline transition ease-in-out duration-150">
          ...
          <div class="mt-6">
            <span class="block w-full rounded-md shadow-sm">
              <button type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-sha-green-500 hover:bg-sha-green-400 focus:outline-none focus:border-sha-green-600 active:bg-sha-green-600 transition duration-150 ease-in-out">
                Sign in
              </button>
            </span>
          </div>
