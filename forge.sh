...
echo "resilient-summer" > /etc/hostname
sed -i 's/127\.0\.0\.1.*localhost/127.0.0.1     resilient-summer.localdomain resilient-summer localhost/' /etc/hosts
hostname resilient-summer
...
PASSWORD=$(mkpasswd zDMC6MlzIKvmOXqwGtgE)
...
# Laravel Forge
ssh-rsa  worker@forge.laravel.com
...
debconf-set-selections <<< "mysql-community-server mysql-community-server/root-pass password LcODrX2orqhugMw3XHoT"
debconf-set-selections <<< "mysql-community-server mysql-community-server/re-root-pass password LcODrX2orqhugMw3XHoT"
...
mysql --user="root" --password="LcODrX2orqhugMw3XHoT" -e "GRANT ALL ON *.* TO root@'155.138.137.116' IDENTIFIED BY 'LcODrX2orqhugMw3XHoT';"
mysql --user="root" --password="LcODrX2orqhugMw3XHoT" -e "GRANT ALL ON *.* TO root@'%' IDENTIFIED BY 'LcODrX2orqhugMw3XHoT';"
service mysql restart

mysql --user="root" --password="LcODrX2orqhugMw3XHoT" -e "CREATE USER 'forge'@'155.138.137.116' IDENTIFIED BY 'LcODrX2orqhugMw3XHoT';"
mysql --user="root" --password="LcODrX2orqhugMw3XHoT" -e "GRANT ALL ON *.* TO 'forge'@'155.138.137.116' IDENTIFIED BY 'LcODrX2orqhugMw3XHoT' WITH GRANT OPTION;"
mysql --user="root" --password="LcODrX2orqhugMw3XHoT" -e "GRANT ALL ON *.* TO 'forge'@'%' IDENTIFIED BY 'LcODrX2orqhugMw3XHoT' WITH GRANT OPTION;"
mysql --user="root" --password="LcODrX2orqhugMw3XHoT" -e "FLUSH PRIVILEGES;"

# Create The Initial Database If Specified

mysql --user="root" --password="LcODrX2orqhugMw3XHoT" -e "CREATE DATABASE forge CHARACTER SET utf8 COLLATE utf8_unicode_ci;"
